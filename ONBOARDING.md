# Onboarding: do zero à primeira rodada
...
Os blocos abaixo descrevem o que cada passo grava e qual é a prova. O formulário cobre os blocos 1, 2, 5, 6 e 7 e recebe os arquivos do 3; o agente fecha o 3 e o 4.
...
Os testes têm que passar **antes** de mexer em qualquer coisa. Se falharem agora, o problema é ambiente, não configuração.
...
O LinkedIn bloqueia scraping. Quem faz isso por nós é um Actor na Apify, pago por vaga coletada (a partir de US$ 2 por 1.000 resultados; com 100 vagas por rodada, cerca de US$ 0,20 a rodada). É a fonte que mais rende: numa medição real, 35 de 37 vagas aprovadas vieram só dela.

1. Crie uma conta em [apify.com](https://apify.com). O plano gratuito serve pra começar.
...
Os três cliques, em imagem: [o botão API](docs/img/apify/01-botao-api.webp), [o menu com API clients](docs/img/apify/02-menu-api-clients.webp) e [a janela com o ícone de copiar](docs/img/apify/03-api-clients-copiar-token.webp).
